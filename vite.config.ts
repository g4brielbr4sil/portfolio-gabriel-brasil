...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: {
      ...
      // Garante uma única cópia do React mesmo quando as deps são re-otimizadas.
      dedupe: ['react', 'react-dom'],
    },
    optimizeDeps: {
      // Cada ícone Phosphor é um módulo próprio; declarar aqui evita que o Vite
      // descubra deps novas em tempo de execução e recarregue com outro hash.
      include: [
        'react',
        'react-dom',
        'react-dom/client',
        ...
        '@phosphor-icons/react/dist/csr/ArrowRight',
        '@phosphor-icons/react/dist/csr/ArrowUpRight',
        '@phosphor-icons/react/dist/csr/Briefcase',
        '@phosphor-icons/react/dist/csr/CaretDown',
        '@phosphor-icons/react/dist/csr/ClipboardText',
        '@phosphor-icons/react/dist/csr/Clock',
        '@phosphor-icons/react/dist/csr/Code',
        '@phosphor-icons/react/dist/csr/DotsThreeOutlineVertical',
        '@phosphor-icons/react/dist/csr/DownloadSimple',
        '@phosphor-icons/react/dist/csr/EnvelopeSimple',
        '@phosphor-icons/react/dist/csr/FlowArrow',
        '@phosphor-icons/react/dist/csr/GitBranch',
        '@phosphor-icons/react/dist/csr/GithubLogo',
        '@phosphor-icons/react/dist/csr/GraduationCap',
        '@phosphor-icons/react/dist/csr/House',
        '@phosphor-icons/react/dist/csr/LinkedinLogo',
        '@phosphor-icons/react/dist/csr/MagnifyingGlass',
        '@phosphor-icons/react/dist/csr/MapPin',
        '@phosphor-icons/react/dist/csr/Moon',
        '@phosphor-icons/react/dist/csr/Plus',
        '@phosphor-icons/react/dist/csr/Pulse',
        '@phosphor-icons/react/dist/csr/RocketLaunch',
        '@phosphor-icons/react/dist/csr/Sparkle',
        '@phosphor-icons/react/dist/csr/SquaresFour',
        '@phosphor-icons/react/dist/csr/Sun',
        '@phosphor-icons/react/dist/csr/User',
        '@phosphor-icons/react/dist/csr/X',
      ],
    },
    server: {
      host: '0.0.0.0',
