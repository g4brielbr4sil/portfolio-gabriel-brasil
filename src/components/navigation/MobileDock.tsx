    ...
    <AnimatePresence>
      {visible && (
        <motion.nav
          ...
          className="fixed inset-x-0 bottom-0 z-40 flex justify-center px-4 pb-[calc(0.75rem+env(safe-area-inset-bottom))] motion-reduce:transition-none min-[56rem]:hidden"
        >
